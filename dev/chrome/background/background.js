...
/* harmony import */ var _utils_constant_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../utils/constant.js */ "./src/utils/constant.js");
...
console.log(_utils_constant_js__WEBPACK_IMPORTED_MODULE_1__["BASE_URL"]);
var axiosInstance = axios__WEBPACK_IMPORTED_MODULE_3___default.a.create({
  baseURL: _utils_constant_js__WEBPACK_IMPORTED_MODULE_1__["BASE_URL"],
  headers: {
    "Content-Type": "application/json"
  },
...
function () {
  ...
  _createClass(Background, [{
    ...
    value: function init() {
      ...
      console.log("loaded BackgroundScripts"); //Redirect to google OAuth when extension installed

      _utils_ext__WEBPACK_IMPORTED_MODULE_0___default.a.runtime.onInstalled.addListener(function () {
        return _this.onInstalled();
      }); //Add message listener in Browser.

      _utils_ext__WEBPACK_IMPORTED_MODULE_0___default.a.runtime.onMessage.addListener(function (message, sender, reply) {
        return _this.onMessage(message, sender, reply);
      }); //Add message listener from Extension

      _utils_ext__WEBPACK_IMPORTED_MODULE_0___default.a.extension.onConnect.addListener(function (port) {
        return _this.onConnect(port);
      }); //Add Update listener for tab

      _utils_ext__WEBPACK_IMPORTED_MODULE_0___default.a.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
    ...
    key: "onClickedExtension",
    value: function onClickedExtension(tabId) {
    ...
    key: "onMessage",
    value: function onMessage(message, sender, reply) {
      console.log("Message from ContentScript", message);

      switch (message.type) {
        case _utils_constant_js__WEBPACK_IMPORTED_MODULE_1__["MSG_CHECKAUTH"]:
          {
            //message for checking Auth
            axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(_utils_constant_js__WEBPACK_IMPORTED_MODULE_1__["API_CHECK_AUTH"]).then(function (res) {
              reply({
                isAuth: true
              });
            })["catch"](function (err) {
    ...
    value: function onConnect(port) {
      ...
      this._port.onMessage.addListener(function (msg) {
        return _this2.onMessageFromExtension(msg);
      });
    }
    /**
    ...
    key: "onMessageFromExtension",
    value: function onMessageFromExtension(msg) {
    ...
    key: "onUpdatedTab",
    value: function onUpdatedTab(tabId, changeInfo, tab) {
      if (tab.url.indexOf("mail.google.com") > -1) {
        // Shows the page action
        _utils_ext__WEBPACK_IMPORTED_MODULE_0___default.a.pageAction.show(tabId);
      }
    }
  }]);
...
/*!*******************************!*\
  !*** ./src/utils/constant.js ***!
  \*******************************/
/*! exports provided: BASE_URL, AUTH_URL, API_CHECK_AUTH, MSG_CHECKAUTH */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_CHECK_AUTH", function() { return API_CHECK_AUTH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MSG_CHECKAUTH", function() { return MSG_CHECKAUTH; });
// import dotenv from "dotenv";
// dotenv.config();
//URL
var BASE_URL = "http://localhost:8000";
var AUTH_URL = BASE_URL + "/auth/google"; //API Endpoints

var API_CHECK_AUTH = "/api/check-auth"; //

var MSG_CHECKAUTH = 10000;
